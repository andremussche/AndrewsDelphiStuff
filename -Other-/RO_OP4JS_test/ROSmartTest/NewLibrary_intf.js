...
// Struct: NewStruct
function NewStruct() {
    this.NewField = {dataType : "AnsiString", value : null};
    this.NewField1 = {dataType : "AnsiString", value : null};
};
NewStruct.prototype = new RemObjects.SDK.ROStructType();
NewStruct.prototype.constructor = NewStruct;
RemObjects.SDK.RTTI["NewStruct"] = NewStruct;
...
NewService.prototype.NewMethod = function(
	__success, __error) {
    try {
        var msg = this.fMessage.clone();
        msg.initialize(this.fServiceName, "NewMethod");
        msg.finalize();
        this.fChannel.dispatch(msg, function (__message) {
		var __result = __message.read("Result", "NewStruct");
	        __success(
		__result
		);
        }, __error);
